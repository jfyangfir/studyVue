...
import { isJS, isCSS } from 'vue/src/server/util'
import TemplateStream from 'vue/src/server/template-renderer/template-stream'
import { parseTemplate } from 'vue/src/server/template-renderer/parse-template'
import { createMapper } from 'vue/src/server/template-renderer/create-async-file-mapper'
import type { ParsedTemplate } from 'vue/src/server/template-renderer/parse-template'
import type { AsyncFileMapper } from 'vue/src/server/template-renderer/create-async-file-mapper'
